...
export class InvestorsComponent implements OnInit {
  ...
  {
    this.loading = true;
    this.adminService.getInvestors().subscribe(
  ...
  addInvestor()
  {
    ...
    this.adminService.addInvestor(designer).subscribe(
      (res) => { console.log(res); this.loading = false; if (res) { this.msg.create('success', 'Investor Created.'); this.ngOnInit(); } },
      (err) => { console.log(err); this.loading = false; this.msg.create('error', 'Error Occured while creating Investor'); }
    )
